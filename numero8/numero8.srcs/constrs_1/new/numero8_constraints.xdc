...
# ## reset signal
# set_property -dict {PACKAGE_PIN Y16 IOSTANDARD LVCMOS18} [get_ports reset]
...
set_property PACKAGE_PIN V12 [get_ports red_detect]
set_property PACKAGE_PIN W16 [get_ports green_detect]
set_property PACKAGE_PIN J15 [get_ports blue_detect]
set_property IOSTANDARD LVCMOS33 [get_ports blue_detect]
set_property IOSTANDARD LVCMOS33 [get_ports green_detect]
set_property IOSTANDARD LVCMOS33 [get_ports red_detect]
