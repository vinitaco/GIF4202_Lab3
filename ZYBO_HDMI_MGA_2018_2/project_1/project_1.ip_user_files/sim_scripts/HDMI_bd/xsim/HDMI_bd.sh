...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xil_defaultlib -L xlconstant_v1_1_7 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot HDMI_bd xil_defaultlib.HDMI_bd xil_defaultlib.glbl -log elaborate.log
}
...
{
  file="xsim.ini"
  lib_map_path="/home/vini/Xilinx/Vivado/2022.1/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
