...
#
# Generated by Vivado on Wed Nov 02 16:49:22 EDT 2022
...
# Script info
echo -e "HDMI_bd.sh - Script generated by export_simulation (Vivado v2022.1 (64-bit)-id)\n"
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../project_1.srcs/sources_1/bd/HDMI_bd/ipshared/4e49" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../../project_1.srcs/sources_1/bd/HDMI_bd/ipshared/4e49" \
  ...
  vlogan -work xlconstant_v1_1_7 $vlogan_opts +v2k +incdir+"$ref_dir/../../../../project_1.srcs/sources_1/bd/HDMI_bd/ipshared/4e49" \
    "$ref_dir/../../../../project_1.srcs/sources_1/bd/HDMI_bd/ipshared/fcfc/hdl/xlconstant_v1_1_vl_rfs.v" \
  2>&1 | tee -a vlogan.log
  ...
  vhdlan -work xil_defaultlib $vhdlan_opts \
    "$ref_dir/../../../bd/HDMI_bd/ip/HDMI_bd_rgb_switch_0_0/sim/HDMI_bd_rgb_switch_0_0.vhd" \
...
create_lib_mappings()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="/home/vini/Documents/FPGA/GIF4202_Lab3/ZYBO_HDMI_MGA_2018_2/project_1/project_1.cache/compile_simlib/vcs"
  fi
